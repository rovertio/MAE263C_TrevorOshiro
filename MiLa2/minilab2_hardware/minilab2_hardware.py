...
class PDwGravityCompensationController:
    ...
    def start_control_loop(self):
        ...
        while self.should_continue:
            ...
            qdot_rad_per_s = (
                np.asarray(list(self.motor_group.velocity_rad_per_s()))
            )
            ...
            u = gravity_comp_torques + self.K_P*q_error - self.K_D*self.qdot_rad_per_s
            # --------------------------------------------------------------------------
